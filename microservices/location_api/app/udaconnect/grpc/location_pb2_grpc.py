...
class LocationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Get = channel.unary_unary(
                '/LocationService/Get',
                request_serializer=location__pb2.LocationReqMessage.SerializeToString,
...
def add_LocationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Get': grpc.unary_unary_rpc_method_handler(
                    servicer.Get,
                    request_deserializer=location__pb2.LocationReqMessage.FromString,
...
class LocationService(object):
    ...
    def Get(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/LocationService/Get',
            location__pb2.LocationReqMessage.SerializeToString,
